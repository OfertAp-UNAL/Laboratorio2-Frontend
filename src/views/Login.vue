      ...
      <div class="col-12 col-sm-10 col-md-8 offset-sm-1 offset-md-2">
        <div class="mt-5">
          <form class="border border-primary rounded form-inline" @submit="login">
            ...
            <h2 class="col-12 text-center text-primary mt-3 mb-5 ofertapp-label">Iniciar Sesi&oacute;n</h2>
            ...
            <div class="col-12 col-sm-6 col-md-5 offset-md-2 text-center mb-3">
              <span class="text-primary">
                <small>
                  <router-link :to="{ name: 'signup' }" class="ofertapp-label">&iquest;No tienes una cuenta?
