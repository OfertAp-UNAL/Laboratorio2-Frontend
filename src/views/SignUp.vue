      ...
      <div class="col-12 col-sm-10 col-md-8 offset-sm-1 offset-md-2">
        <div id="signUp" class="mt-5">
          ...
          <form class="border border-primary rounded form-inline" @submit="signUp">
            ...
            <h2 class="col-12 text-center text-primary mt-3 mb-5 ofertapp-label">Registro</h2>
            ...
            <div class="form-group col-12">
              ...
              <input id="cPassword" class="form-control col-12 col-sm-10 col-md-7 offset-sm-1" type="password"
                placeholder="Confirmar Contraseña" v-model="cPassword" required :class="{
            ...
            <div class="col-12 col-sm-6 col-md-5 offset-md-2 text-center mb-3">
              <span class="text-primary">
                <small>
                  <router-link :to="{ name: 'login' }" class="ofertapp-label">&iquest;Ya tienes cuenta? Inicia
            ...
            <div class="col-12 col-sm-5 col-md-4 mb-3">
              <button class="col-sm-10 col-md-10 offset-sm-1 offset-md-2 btn btn-primary ofertapp-button" type="submit">
                Registrar
              </button>
            </div>
